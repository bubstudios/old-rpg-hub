...
import {
  ...
  rollAbilityScores, computeHP, getNerveMod, getInitiativeMod,
...
export default function GangCharacterCreation() {
  ...
  async function handleCreate() {
    ...
    try {
      ...
      toast.success(`${name} hits the streets!`);
  ...
  const nerMod = rawScores ? getNerveMod(rawScores) : 0;
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="flex items-center gap-2 mb-6">
        ...
        <h1 className="font-heading font-700 text-lg text-foreground tracking-wide">CREATE CHARACTER · GANGBUSTERS</h1>
      </div>
      ...
      <div className="border border-border/50 rounded-lg bg-card/40 panel-glow p-6 sm:p-8 min-h-[320px]">
        ...
        {step === 1 && (
          <div className="animate-ink">
            ...
            <p className="text-[11px] text-muted-foreground font-body mb-4">
              Gangbusters uses six percentile attributes (1-100). Roll d100 for each. Your Muscle is your Grit — how much lead you can take before you drop.
            </p>
            {!scoresRolled ? (
              <button
        ...
        {step === 2 && (
          <div className="animate-ink">
            ...
            <p className="text-[11px] text-muted-foreground font-body mb-4">
              Your archetype grants starting skills. Your attribute total grants {bonusSlots} additional skill{bonusSlots === 1 ? '' : 's'} to pick from the list below — the resourceful compensate for weakness.
            </p>
          ...
          <div className="animate-ink space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                placeholder="e.g. Mickey 'The Blade' O'Brien"
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Sharp pinstripe suit, slicked-back hair, a scar along the jaw..."
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Fresh off the boat from Sicily, worked his way up from street corner to the boss's inner circle..."
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="p-3 rounded-lg bg-secondary/30 border border-border/40 text-center">
                  <p className="text-[10px] font-heading tracking-wide text-muted-foreground">GRIT</p>
                ...
                <div className="p-3 rounded-lg bg-secondary/30 border border-border/40 text-center">
                  <p className="text-[10px] font-heading tracking-wide text-muted-foreground">NERVE</p>
                  <p className="font-heading font-700 text-lg text-foreground">{nerMod >= 0 ? '+' : ''}{nerMod}%</p>
                </div>
              </div>
              <div className="p-3 rounded-lg bg-secondary/30 border border-border/40">
              ...
              <div className="p-3 rounded-lg bg-secondary/30 border border-border/40">
                ...
                <div className="flex gap-1.5 flex-wrap">
                  ...
                  <span className="text-[10px] px-1.5 py-0.5 rounded bg-background/40 text-primary font-heading">${ar?.dollars || 0}</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="flex justify-between mt-5">
        ...
        {step < STEPS.length - 1 ? (
          ...
          <Button
            ...
            className="bg-primary text-primary-foreground hover:bg-primary/90"
          >
            {creating ? <Loader2 className="w-4 h-4 animate-spin" /> : <><Crosshair className="w-4 h-4 mr-1.5" /> Hit the Streets</>}
          </Button>
        )}
      </div>
    </div>
