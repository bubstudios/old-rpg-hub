...
import {
  ...
  rollAbilityScores, computeHP, getMentationMod, getInitiativeMod,
  skillCountFor, bestWeaponSkillLevel
} from '@/lib/hyRules';
import { Dices, ChevronLeft, ChevronRight, Check, Loader2, Flame, Sparkles, FileText } from 'lucide-react';
...
export default function HyCharacterCreation() {
  ...
  useEffect(() => {
    base44.functions.invoke('campaignData', { op: 'load', campaign_id: campaignId })
      .then(res => setGameSystem(res.data.campaign.game_system || 'conan'))
      .catch(() => setGameSystem('conan'));
  }, [campaignId]);
  ...
  if (importMode) {
    return (
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
        ...
        >
          <ChevronLeft className="w-3.5 h-3.5" /> Back to Warrior Builder
        </button>
  ...
  const sysLabel = gameSystem === 'redsonja' ? 'RED SONJA' : 'CONAN';
  ...
  async function handleCreate() {
    ...
    try {
      ...
      toast.success(`${name} strides into the Hyborian Age!`);
  ...
  const menMod = rawScores ? getMentationMod(rawScores) : 0;
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="flex items-center gap-2 mb-6">
        ...
        <h1 className="font-heading font-700 text-lg text-foreground tracking-wide">CREATE WARRIOR · {sysLabel}</h1>
      </div>
        ...
        {step === 1 && (
          <div className="animate-ink">
            ...
            <p className="text-[11px] text-muted-foreground font-body mb-4">
              The Hyborian Age uses eight percentile attributes (1-100). Roll d100 for each. Your Endurance is your Vitality — how much punishment you can take before you fall.
            </p>
            {!scoresRolled ? (
              <button
          ...
          <div className="animate-ink space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                placeholder={gameSystem === 'redsonja' ? "e.g. Sonya of Hyrkania" : "e.g. Conan of Cimmeria"}
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Scarred and sun-bronzed, black mane of hair, eyes like cold steel..."
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="A wanderer with blood on his hands and gold in his belt, hunted by a king's soldiers across the Hyborian kingdoms..."
          ...
          <div className="animate-ink">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <div className="p-3 rounded-lg bg-secondary/30 border border-border/40 text-center">
                  <p className="text-[10px] font-heading tracking-wide text-muted-foreground">MENTATION</p>
                  <p className="font-heading font-700 text-lg text-foreground">{menMod >= 0 ? '+' : ''}{menMod}%</p>
                </div>
              </div>
              <div className="p-3 rounded-lg bg-secondary/30 border border-border/40">
              ...
              <div className="p-3 rounded-lg bg-secondary/30 border border-border/40">
                ...
                <div className="flex gap-1.5 flex-wrap">
                  ...
                  <span className="text-[10px] px-1.5 py-0.5 rounded bg-background/40 text-primary font-heading">{ar?.gold || 0} gold</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="flex justify-between mt-5">
        ...
        {step < STEPS.length - 1 ? (
          ...
          <Button
            ...
            className="bg-primary text-primary-foreground hover:bg-primary/90"
          >
            {creating ? <Loader2 className="w-4 h-4 animate-spin" /> : <><Flame className="w-4 h-4 mr-1.5" /> Stride Forth</>}
          </Button>
        )}
      </div>
    </div>
