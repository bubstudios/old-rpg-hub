...
import {
  ...
  rollAbilityScores, computeHP, getCourageMod, getInitiativeMod,
  skillCountFor, bestWeaponSkillLevel
} from '@/lib/tsRules';
import { Dices, ChevronLeft, ChevronRight, Check, Loader2, Briefcase, Sparkles, FileText } from 'lucide-react';
...
export default function TSCharacterCreation() {
  ...
  if (importMode) {
    return (
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
        ...
        >
          <ChevronLeft className="w-3.5 h-3.5" /> Back to Agent Builder
        </button>
  ...
  async function handleCreate() {
    ...
    try {
      ...
      toast.success(`${name} is deployed and ready for action!`);
  ...
  const courMod = rawScores ? getCourageMod(rawScores) : 0;
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="flex items-center gap-2 mb-6">
        ...
        <h1 className="font-heading font-700 text-lg text-foreground tracking-wide">CREATE AGENT · TOP SECRET</h1>
      </div>
      ...
      <div className="border border-border/50 rounded-lg bg-card/40 panel-glow p-6 sm:p-8 min-h-[320px]">
        ...
        {step === 1 && (
          <div className="animate-ink">
            ...
            <p className="text-[11px] text-muted-foreground font-body mb-4">
              Top Secret uses seven percentile attributes (1-100). Roll d100 for each. Your Physical Strength is your Vitality — how much punishment you can take before you fall.
            </p>
            {!scoresRolled ? (
              <button
        ...
        {step === 2 && (
          <div className="animate-ink">
            ...
            <p className="text-[11px] text-muted-foreground font-body mb-4">
              Your archetype grants starting skills. Your attribute total grants {bonusSlots} additional skill{bonusSlots === 1 ? '' : 's'} to pick from the tradecraft list below — the resourceful compensate for weakness.
            </p>
        ...
        {step === 3 && (
          <div className="animate-ink space-y-4">
            ...
            <div>
              <label className="text-[11px] font-heading tracking-wide text-muted-foreground">CODENAME / NAME</label>
              <Input
                value={name}
                onChange={(e) => setName(e.target.value)}
                placeholder="e.g. Jack Dalton, Agent Kestrel"
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Tailored grey suit, calm grey eyes, a face made for forgetting..."
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Burned by the Company after the Vienna affair, working freelance for anyone who pays in dollars and discretion..."
          ...
          <div className="animate-ink">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <div className="p-3 rounded-lg bg-secondary/30 border border-border/40 text-center">
                  <p className="text-[10px] font-heading tracking-wide text-muted-foreground">COURAGE</p>
                  <p className="font-heading font-700 text-lg text-foreground">{courMod >= 0 ? '+' : ''}{courMod}%</p>
                </div>
              </div>
              <div className="p-3 rounded-lg bg-secondary/30 border border-border/40">
              ...
              <div className="p-3 rounded-lg bg-secondary/30 border border-border/40">
                <p className="text-[10px] font-heading tracking-wide text-muted-foreground mb-2">FIELD KIT</p>
                <div className="flex gap-1.5 flex-wrap">
      ...
      <div className="flex justify-between mt-5">
        ...
        {step < STEPS.length - 1 ? (
          ...
          <Button
            ...
            className="bg-primary text-primary-foreground hover:bg-primary/90"
          >
            {creating ? <Loader2 className="w-4 h-4 animate-spin" /> : <><Briefcase className="w-4 h-4 mr-1.5" /> Deploy</>}
          </Button>
        )}
      </div>
    </div>
