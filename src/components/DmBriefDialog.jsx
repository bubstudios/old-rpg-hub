...
export default function DmBriefDialog({ open, onOpenChange, campaignId, initialBrief }) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto ornate-frame">
        <DialogHeader>
          <div className="flex items-center gap-2.5">
            ...
            <DialogTitle className="font-heading tracking-wide text-lg">Dungeon Master Brief</DialogTitle>
          </div>
        </DialogHeader>
        ...
        <div className="space-y-4 mt-2">
          ...
          <Field label="NPC Behavior" hint="How NPCs should act and speak">
            <Textarea
              ...
              className="min-h-[70px] font-body text-sm bg-background/60"
            />
          </Field>
          ...
          <Field label="Custom Instructions" hint="Any other house rules or notes for the DM">
            <Textarea
              ...
              className="min-h-[100px] font-body text-sm bg-background/60"
            />
          </Field>
        </div>
...
function Field({ label, hint, children }) {
  return (
    <div>
      <Label className="text-[11px] font-heading tracking-wide text-foreground">{label}</Label>
